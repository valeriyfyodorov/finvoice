...
urlpatterns = [
    ...
    path('companies_accounts_payments', login_required(views.companies_accounts_payments), name='companies_accounts_payments'),
    path('companies_accounts_financial', login_required(views.companies_accounts_financial), name='companies_accounts_financial'),
    ...
    path('deal/update/<int:deal_id>/', views.DealUpdateView.as_view(), name='deal_update'),
    ...
    path('deal/<int:deal_id>/', views.DealDetailView.as_view(), name='deal_detail'),
